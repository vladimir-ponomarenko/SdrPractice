...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._a_range = Range(88.7, 110.1, 0.2, 101.1, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.iio_pluto_source_1 = iio.fmcomms2_source_fc32('192.168.3.1' if '192.168.3.1' else iio.get_pluto_uri(), [True, True], 32768)
        self.iio_pluto_source_1.set_len_tag_key('packet_len')
        self.iio_pluto_source_1.set_frequency((int(a*1e6)))
        ...
        self.connect((self.iio_pluto_source_1, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_a(self, a):
        self.a = a
        self.iio_pluto_source_1.set_frequency((int(self.a*1e6)))
